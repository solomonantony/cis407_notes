...
-- other tables with the same PostgreSQL schema.
-- PostgreSQL only
...
-- This statement will not execute in Oracle due to nextval function in the DEFAULT clause.
CREATE TABLE SSSales
( 	SalesNo 	INTEGER NOT NULL DEFAULT nextval('sssalesnoseq'),
